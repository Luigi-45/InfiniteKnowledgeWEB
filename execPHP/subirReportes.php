<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if(!empty($_FILES)){
            ...
            try{
                $file = $dropbox->simpleUpload($tempfile,'/Reportes de Calificaciones'.$nombreDropbox,['autorename' => true]);
                if($file){
                    echo "<p> Se ha subido el reporte de calificaciones satisfactoriamente </p>";
                }
            }
            catch(\Exception $e){
                throw $e;
